...
const Entrenadores = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('Hubo un error al agregar o actualizar el autor');
        } finally {
            setCargando(false);
        }
    };
    ...
    const handleEliminar = async (id) => {
        if (window.confirm('¿Estás seguro de que deseas eliminar este autor?')) {
            try {
                ...
                setError('Hubo un error al eliminar el autor');
            } finally {
                setCargando(false);
            }
        }
    ...
    return (
        <div className="entradores-container">
            ...
            <div className="entradores-content">
                <h1 className="title">Gestión de Autores</h1>
                ...
                <form onSubmit={handleSubmit} className="form-container">
                    <h2 className="form-title">
                        ...
                        {modoEdicion ? 'Editar autor' : 'Agregar Nuevo autor'}
                    </h2>
                    ...
                    <div className="input-group">
                        <label htmlFor="especialidad" className="input-label">Genero</label>
                        <input
                            type="text"
                            id="especialidad"
                            value={especialidad}
                            ...
                            className="input-field"
                            placeholder="Ej: Misterio, Accion, Historia"
                        />
                    </div>
                    ...
                    <button
                        ...
                        disabled={cargando}
                    >
                        {cargando ? 'Cargando...' : modoEdicion ? 'Actualizar Autor' : 'Agregar Autor'}
                    </button>
                </form>

                {/* Lista de Entrenadores */}
                <h2 className="list-title">Autores Registrados</h2>
                <div className="trainer-list">
                    {entrenadores.length > 0 ? (
                        ...
                        <div className="no-trainers-message">No hay autores</div>
                    )}
                </div>
            </div>
        </div>
